    ...
    <section className="container-edge py-20">
      <div className="on-navy relative overflow-hidden rounded-lg bg-brand-btn px-8 py-14 text-white sm:px-14 lg:flex lg:items-center lg:justify-between lg:gap-12">
        <div className="max-w-2xl">
          <span className="text-xs font-extrabold uppercase tracking-[.16em] text-white/70">Ready when you are</span>
          <h2 className="mt-4 text-[clamp(1.9rem,3.8vw,3rem)]">Let's get your TV <span className="font-serif font-medium italic">on the wall.</span></h2>
